...
class RunnerIter(RunnerBase):
    ...
    def train(self):
        ...
        if not self.evaluate_only and self.resume_ckpt_path is not None:
            ...
            # pass the trained dataset
            # trained_epoch = int((self.start_iters-1) // self.iters_per_inner_epoch) - 1
            trained_epoch = 0
            self.train_loader._dataset.datasets[0].pipeline[0].epoch = trained_epoch
            logging.info("resume model and skip dataset by trained epoch {}".format(trained_epoch))
