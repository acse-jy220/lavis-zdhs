...
@registry.register_model("blip2_llama_instruct")
class Blip2LlamaInstruct(Blip2Base):
    ...
    Usage:
        ...
        >>> model = load_model("blip2_llama_instruct", "llama13b")
    """

    PRETRAINED_MODEL_CONFIG_DICT = {
        "llama13b": "configs/models/zdtc/blip2_instruct_llama13b.yaml",
        "llama13b_server": "configs/models/zdtc/blip2_instruct_llama13b_server.yaml",
    }
